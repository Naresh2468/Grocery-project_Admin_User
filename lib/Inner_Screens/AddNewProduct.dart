...
import 'package:gstore_admin_panel/screens/loading_manager.dart';
...
// how to access the Firebase_core packages as variable beacuse the firebase is replaced  Firebase_core.
// this Firebase is replaced to Firebase_core have view import package firbase core in this file.
...
class _UploadProductFormState extends State<UploadProductForm> {
  ...
  void _uploadForm() async {
    ...
    if (isValid) {
      ...
      // THis use for the image session is necessary for the Prodcut upload
      if (_pickedImage == null) {
        GlobalMethods.ErrorDialog(
            subtitle: "Please pickup the product image!!", context: context);
        return;
      }
      final _uuid = Uuid().v4();
      try {
        ...
        await FirebaseFirestore.instance.collection('products').doc(_uuid).set({
          // this Part is use for the Database attributes.

          "id": _uuid,
          'title': _titleController.text,
          'price': _titleController.text,
          'salePrice': 0.1,
          'imageAsset': imageUri.toString(),
          'productCategroyName': _catValue,
          'isOnSale': false,
          'isPiece': isPiece,
        ...
        //print("Successfully Registered , Bro!!!!");
        // Navigator.of(context).pushReplacement(MaterialPageRoute(
        //   builder: (context) => const BottomBarScreen(),
        // ));
      } on FirebaseException catch (error) {
        GlobalMethods.ErrorDialog(subtitle: "$error", context: context);
        //print("Hey Man you Got the Error Resolve it,Try Again$error");
        setState(() {
          _isLoading = false;
        });
      } catch (error) {
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: TextFormField(
                                            ...
                                            validator: (value) {
                                              if (value!.isEmpty) {
                                                return 'Price of Product is missed ? ';
                                              }
                                              return null;
                                            },
                                            inputFormatters: <
  ...
  Future<void> _pickImage() async {
    if (!kIsWeb) {
      ...
      print("OOPS! Something Went wrong , Check Connection.");
    }
  }
          ...
          child: Column(
            ...
            children: [
              ...
              TextButton(
                  ...
                  child: TextWidget(
                      text: 'Choose a Image',
                      color: Color.fromARGB(255, 43, 143, 225)))
            ],
          ),
        ),
      ),
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          hint: const Text('Select the Product Category'),
          items: const [
            DropdownMenuItem(
              child: Text(
                "Vegetables",
